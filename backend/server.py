...
async def startup_event():
    ...
    try:
        ...
        await db.managed_servers.create_index("container_name", unique=True, sparse=True)
        await db.managed_servers.create_index("data_root", unique=True, sparse=True)
        await db.managed_servers.create_index("ports.game", unique=True, sparse=True)
        await db.managed_servers.create_index("ports.query", unique=True, sparse=True)
        await db.managed_servers.create_index("ports.rcon", unique=True, sparse=True)
