import type { ConflictZone, Hotspot, Earthquake, NewsItem, MilitaryBase, StrategicWaterway, APTGroup, NuclearFacility, EconomicCenter, GammaIrradiator, Pipeline, UnderseaCable, CableAdvisory, RepairShip, InternetOutage, AIDataCenter, AisDisruptionEvent, SocialUnrestEvent, AirportDelayAlert, MilitaryFlight, MilitaryVessel, MilitaryFlightCluster, MilitaryVesselCluster } from '@wm/types';
import type { WeatherAlert } from '@wm/services/weather';
import { UNDERSEA_CABLES } from '@wm/config';
import { escapeHtml, sanitizeUrl } from '@wm/utils/sanitize';
import { isMobileDevice } from '@wm/utils';
import { fetchHotspotContext, formatArticleDate, extractDomain, type GdeltArticle } from '@wm/services/gdelt-intel';
