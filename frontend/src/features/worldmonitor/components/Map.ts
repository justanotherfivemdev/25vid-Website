...
import { escapeHtml } from '@wm/utils/sanitize';
import type { Topology, GeometryCollection } from 'topojson-specification';
import type { MapLayers, Hotspot, NewsItem, Earthquake, InternetOutage, RelatedAsset, AssetType, AisDisruptionEvent, AisDensityZone, CableAdvisory, RepairShip, SocialUnrestEvent, AirportDelayAlert, MilitaryFlight, MilitaryVessel, MilitaryFlightCluster, MilitaryVesselCluster } from '@wm/types';
import type { WeatherAlert } from '@wm/services/weather';
import { getSeverityColor } from '@wm/services/weather';
import {
  MAP_URLS,
  INTEL_HOTSPOTS,
  CONFLICT_ZONES,
