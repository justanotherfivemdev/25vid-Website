import type { SocialUnrestEvent, ProtestSeverity, ProtestEventType } from '@wm/types';
import { INTEL_HOTSPOTS } from '@wm/config';
import { generateId, createCircuitBreaker } from '@wm/utils';
