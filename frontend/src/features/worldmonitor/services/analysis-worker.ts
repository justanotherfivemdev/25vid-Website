...
import type { NewsItem, ClusteredEvent, PredictionMarket, MarketData } from '@wm/types';
import type { CorrelationSignal } from './correlation';
import { SOURCE_TIERS, SOURCE_TYPES, type SourceType } from '@wm/config/feeds';

// Import worker using Vite's worker syntax
import AnalysisWorker from '@wm/workers/analysis.worker?worker';
