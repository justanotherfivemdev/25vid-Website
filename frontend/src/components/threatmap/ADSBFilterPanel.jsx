...
export default function ADSBFilterPanel({ countries = [], aircraftCount = 0 }) {
  ...
  return (
    <div className="absolute bottom-4 left-16 md:left-20 z-10 w-64">
      ...
      <button
        ...
        className={`w-full flex items-center justify-between gap-2 px-3 py-2 rounded-t-lg text-xs font-semibold transition-all ${
          ...
          hasActiveFilters
            ...
            : 'bg-black/85 text-gray-300 border border-gray-700/50'
      ...
      {/* Filter panel body */}
      {expanded && (
        <div className="bg-black/90 backdrop-blur-md border border-t-0 border-gray-700/50 rounded-b-lg p-3 space-y-3 shadow-lg">
          {/* Callsign search */}
          <div>
            ...
            <input
              ...
              className="mt-1 w-full px-2 py-1.5 rounded bg-gray-800/80 border border-gray-700/50 text-xs text-gray-200 placeholder-gray-500 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 w-full px-2 py-1.5 rounded bg-gray-800/80 border border-gray-700/50 text-xs text-gray-200 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 appearance-none"
            >
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-2">
              <input
                ...
                placeholder="Min"
                min="0"
                className="w-1/2 px-2 py-1.5 rounded bg-gray-800/80 border border-gray-700/50 text-xs text-gray-200 placeholder-gray-500 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20"
              />
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-9 h-5 rounded-full transition-colors duration-200 ${
                adsbFilters.showOnGround ? 'bg-cyan-600' : 'bg-gray-600'
              }`}
            >
              <span
          ...
          {hasActiveFilters && (
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 px-2 py-1.5 rounded bg-gray-800/60 hover:bg-gray-700/60 border border-gray-700/40 text-xs text-gray-400 hover:text-gray-200 transition-colors"
            >
