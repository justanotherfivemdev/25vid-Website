      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur border-b border-tropic-red/30">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link to="/"><Button size="sm" variant="outline" className="border-gray-700"><ArrowLeft className="w-4 h-4 mr-1" />Home</Button></Link>
          ...
          <Link to="/login"><Button size="sm" className="bg-tropic-red hover:bg-tropic-red-dark">Member Login</Button></Link>
        </div>
      </nav>
        ...
        <div className="container mx-auto max-w-5xl space-y-10">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center gap-6 pt-4">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-tropic-red">Active</div>
          ...
          <Card className="bg-gray-900/50 border-tropic-red/20">
            <CardHeader>
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="flex items-start gap-3">
                  <Target className="w-5 h-5 text-tropic-red shrink-0 mt-0.5" />
                  <div>
            ...
            {loading ? (
              ...
              <Card className="bg-gray-900/50 border-gray-800">
                <CardContent className="py-12 text-center">
                  ...
                  <Button onClick={() => { setSelectedBillet(null); setApplicationOpen(true); }} className="mt-4 bg-tropic-red hover:bg-tropic-red-dark">
                  ...
                  <div key={company}>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {companyBillets.map(billet => (
                        <Card key={billet.id} className="bg-gray-900/80 border-gray-800 hover:border-tropic-red/40 transition-colors" data-testid={`billet-${billet.id}`}>
                          ...
                          <CardContent>
                            ...
                            {billet.requirements && (
                              <div className="text-xs text-gray-500 mb-3 border-l-2 border-tropic-red/30 pl-2">
                                <span className="text-gray-400">Requirements:</span> {billet.requirements}
                              </div>
                            )}
                            <Button onClick={() => handleApply(billet)} className="w-full bg-tropic-red hover:bg-tropic-red-dark" data-testid={`apply-${billet.id}`}>
            ...
            <DialogContent className="bg-gray-900 text-white border-gray-800 max-w-lg max-h-[90vh] overflow-y-auto">
              ...
              {submitted ? (
                <div className="text-center py-6 space-y-4">
                  ...
                  <Button onClick={() => { setApplicationOpen(false); setSubmitted(false); }} className="bg-tropic-red hover:bg-tropic-red-dark">
                    Close
                  </Button>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <Button type="submit" disabled={submitting} className="bg-tropic-red hover:bg-tropic-red-dark flex-1" data-testid="apply-submit">
