...
const MemberHub = () => {
  ...
  const getTypeColor = (t) => ({ combat: 'bg-[#ff3333]', training: 'bg-[#c9a227]', recon: 'bg-green-600', support: 'bg-gray-600' }[t] || 'bg-gray-600');
  const getPriorityColor = (p) => ({ urgent: 'text-[#ff3333] border-[#ff3333]', high: 'text-orange-500 border-orange-500', normal: 'text-[#e8c547] border-[#e8c547]', low: 'text-gray-400 border-gray-400' }[p] || 'text-gray-400 border-gray-400');
  ...
  return (
    <div className={inLayout ? '' : 'min-h-screen bg-[#050a0e] text-[#d0d8e0]'}>
      ...
      {!inLayout && (
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050a0e]/95 backdrop-blur-xl border-b border-[rgba(0,255,136,0.1)]" data-testid="member-nav">
        <div className="container mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={`${BACKEND_URL}/api/uploads/25th_id_patch.png`} alt="25th ID" className="w-8 h-8 object-contain" />
            <h1 className="text-xl font-bold tracking-[0.12em] text-[#e8c547]" style={{ fontFamily: "'Orbitron', sans-serif" }}>25TH ID HUB</h1>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-sm text-[#8a9aa8] hidden lg:block">Welcome, <span className="text-[#00ff88] font-bold">{user?.username}</span></span>
            {/* Desktop nav links */}
            <div className="hidden md:flex items-center space-x-2">
              <Link to="/hub/profile"><Button size="sm" variant="outline" className="border-[rgba(0,255,136,0.15)]"><User className="w-4 h-4 mr-1" />Profile</Button></Link>
              <Link to="/roster"><Button size="sm" variant="outline" className="border-[rgba(0,255,136,0.15)]"><Users className="w-4 h-4 mr-1" />Roster</Button></Link>
              <Link to="/hub/gallery"><Button size="sm" variant="outline" className="border-[rgba(0,255,136,0.15)]"><Image className="w-4 h-4 mr-1" />Gallery</Button></Link>
              <Link to="/hub/loa"><Button variant="ghost" size="sm" className="text-[#8a9aa8] hover:text-[#00ff88]"><Calendar className="w-4 h-4 mr-1.5" />LOA</Button></Link>
              <Link to="/hub/shared"><Button variant="ghost" size="sm" className="text-[#8a9aa8] hover:text-[#00ff88]"><Handshake className="w-4 h-4 mr-1.5" />Shared</Button></Link>
              <Link to="/hub/campaign"><Button size="sm" variant="outline" className="border-[#00ff88]/40 text-[#00ff88] hover:bg-[#00ff88]/10"><MapPin className="w-4 h-4 mr-1" />Campaigns</Button></Link>
              <Link to="/hub/threat-map"><Button size="sm" variant="outline" className="border-[#00ff88]/40 text-[#00ff88] hover:bg-[#00ff88]/10"><Globe className="w-4 h-4 mr-1" />Global Threat Map</Button></Link>
              {isStaff(user?.role) && (
              ...
              <Link to="/"><Button size="sm" variant="outline" className="border-[rgba(0,255,136,0.15)]"><Home className="w-4 h-4 mr-1" />Home</Button></Link>
              <Button size="sm" variant="outline" onClick={handleLogout} className="border-[rgba(0,255,136,0.15)]" data-testid="member-logout-btn"><LogOut className="w-4 h-4" /></Button>
            </div>
            {/* Mobile hamburger */}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-[rgba(0,255,136,0.1)] bg-[#050a0e]/95 backdrop-blur-xl px-4 py-3 space-y-1">
            <Link to="/hub/profile" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#d0d8e0] hover:text-[#00ff88] hover:bg-[#00ff88]/10"><User className="w-4 h-4" />Profile</Link>
            <Link to="/roster" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#d0d8e0] hover:text-[#00ff88] hover:bg-[#00ff88]/10"><Users className="w-4 h-4" />Roster</Link>
            <Link to="/hub/gallery" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#d0d8e0] hover:text-[#00ff88] hover:bg-[#00ff88]/10"><Image className="w-4 h-4" />Gallery</Link>
            <Link to="/hub/loa" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#d0d8e0] hover:text-[#00ff88] hover:bg-[#00ff88]/10"><Calendar className="w-4 h-4" />LOA</Link>
            <Link to="/hub/shared" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#d0d8e0] hover:text-[#00ff88] hover:bg-[#00ff88]/10"><Handshake className="w-4 h-4" />Shared</Link>
            <Link to="/hub/campaign" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#00ff88] hover:bg-[#00ff88]/10"><MapPin className="w-4 h-4" />Campaigns</Link>
            <Link to="/hub/threat-map" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#00ff88] hover:bg-[#00ff88]/10"><Globe className="w-4 h-4" />Global Threat Map</Link>
            {isStaff(user?.role) && (
            ...
            <Link to="/" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm text-[#d0d8e0] hover:text-[#00ff88] hover:bg-[#00ff88]/10"><Home className="w-4 h-4" />Home</Link>
      ...
      <div className={`${inLayout ? 'pt-4' : 'pt-20'} pb-12 px-4 md:px-6`}>
        <div className="container mx-auto max-w-7xl space-y-8">
          ...
          <div className="bg-[#0c1117] border border-[rgba(0,255,136,0.15)] corner-bracket p-4 sm:p-6" data-testid="member-welcome-banner">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-[#e8c547] tracking-[0.1em]" style={{ fontFamily: "'Orbitron', sans-serif" }}>OPERATIONS HUB</h2>
              ...
              <form onSubmit={handleSearch} className="flex gap-2 w-full md:w-auto">
                <div className="relative flex-1 md:w-72">
                  ...
                  <Input
                    ...
                    className="bg-[#050a0e]/50 border-[rgba(0,255,136,0.15)] pl-10"
                    data-testid="hub-search-input"
                  />
                </div>
                <Button type="submit" disabled={searching || searchQuery.length < 2} className="tactical-button bg-[#00ff88] text-[#050a0e] hover:bg-[#00cc6a] shrink-0" data-testid="hub-search-btn">
                  {searching ? '...' : 'Search'}
                </Button>
                {searchResults && <Button type="button" variant="outline" onClick={clearSearch} className="border-[rgba(0,255,136,0.15)] shrink-0" data-testid="hub-search-clear">Clear</Button>}
              </form>
            </div>
          </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    {searchResults.operations.map(op => (
                      <Link to={`/hub/operations/${op.id}`} key={op.id}>
                        <Card className="bg-[#0c1117] border-[rgba(0,255,136,0.1)] hover:border-[#00ff88]/30 transition-colors corner-bracket" data-testid={`search-op-${op.id}`}>
                  ...
                  <div className="space-y-2">
                    {searchResults.discussions.map(d => (
                      <Link to={`/hub/discussions/${d.id}`} key={d.id}>
                        <Card className="bg-[#0c1117] border-[rgba(0,255,136,0.1)] hover:border-[#00ff88]/30 transition-colors" data-testid={`search-disc-${d.id}`}>
                          <CardContent className="py-3 flex items-center gap-3">
                            {d.pinned && <Pin className="w-3 h-3 text-[#e8c547] shrink-0" />}
                            <Badge variant="outline" className="text-xs border-[rgba(0,255,136,0.15)]">{d.category}</Badge>
            ...
            <Card className="bg-[#0c1117] border-[#e8c547]/40 corner-bracket" data-testid="motw-card">
              <CardContent className="p-5 flex items-center gap-5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-lg font-bold tracking-wide" style={{ fontFamily: "'Orbitron', sans-serif" }}>{motw.username}</div>
          ...
          {mySchedule.length > 0 && (
            <section data-testid="my-schedule-section">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                {mySchedule.map(op => (
                  <Link to={`/hub/operations/${op.id}`} key={op.id}>
                    <Card className="bg-[#0c1117] border-[rgba(0,255,136,0.1)] hover:border-[#00ff88]/30 transition-colors h-full" data-testid={`schedule-op-${op.id}`}>
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
            <Link to="/hub/discussions" className="bg-[#0c1117] border border-[rgba(0,255,136,0.1)] p-3 sm:p-4 hover:border-[#00ff88]/30 active:bg-[#111a24] transition-colors text-center" data-testid="hub-nav-discussions">
              <MessageSquare className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-1.5 sm:mb-2 text-[#00ff88]" /><span className="font-medium text-xs sm:text-sm">Discussions</span>
            </Link>
            <a href="#ops" className="bg-[#0c1117] border border-[rgba(0,255,136,0.1)] p-3 sm:p-4 hover:border-[#00ff88]/30 active:bg-[#111a24] transition-colors text-center">
              <Calendar className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-1.5 sm:mb-2 text-[#00ff88]" /><span className="font-medium text-xs sm:text-sm">Operations</span>
            </a>
            <a href="#training" className="bg-[#0c1117] border border-[rgba(0,255,136,0.1)] p-3 sm:p-4 hover:border-[#00ff88]/30 active:bg-[#111a24] transition-colors text-center">
              <BookOpen className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-1.5 sm:mb-2 text-[#00ff88]" /><span className="font-medium text-xs sm:text-sm">Training</span>
            </a>
            <Link to="/hub/intel" className="bg-[#0c1117] border border-[rgba(0,255,136,0.1)] p-3 sm:p-4 hover:border-[#00ff88]/30 active:bg-[#111a24] transition-colors text-center" data-testid="hub-nav-intel">
              <Megaphone className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-1.5 sm:mb-2 text-[#00ff88]" /><span className="font-medium text-xs sm:text-sm">Intel Board</span>
            </Link>
            <Link to="/hub/campaign" className="bg-[#0c1117] border border-[rgba(0,255,136,0.1)] p-3 sm:p-4 hover:border-[#00ff88]/30 active:bg-[#111a24] transition-colors text-center" data-testid="hub-nav-campaign">
              <MapPin className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-1.5 sm:mb-2 text-[#00ff88]" /><span className="font-medium text-xs sm:text-sm">Campaigns</span>
            </Link>
            <Link to="/hub/gallery" className="bg-[#0c1117] border border-[rgba(0,255,136,0.1)] p-3 sm:p-4 hover:border-[#00ff88]/30 active:bg-[#111a24] transition-colors text-center" data-testid="hub-nav-gallery">
              <Image className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-1.5 sm:mb-2 text-[#00ff88]" /><span className="font-medium text-xs sm:text-sm">Gallery</span>
            </Link>
          </div>
          ...
          <section id="intel">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-2xl font-bold text-[#e8c547]" style={{ fontFamily: "'Orbitron', sans-serif" }}>LATEST INTEL</h3>
            </div>
            {announcements.length === 0 ? <p className="text-[#4a6070]">No announcements.</p> : (
              <div className="grid md:grid-cols-2 gap-4">
                {announcements.map((a) => (
                  <Card key={a.id} className="bg-[#0c1117] border-[rgba(0,255,136,0.1)] corner-bracket" data-testid={`hub-announcement-${a.id}`}>
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-lg" style={{ fontFamily: "'Orbitron', sans-serif" }}>{a.title}</CardTitle>
                    </CardHeader>
          ...
          <section id="ops">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-2xl font-bold text-[#e8c547]" style={{ fontFamily: "'Orbitron', sans-serif" }}>UPCOMING OPERATIONS</h3>
            </div>
            {operations.length === 0 ? <p className="text-[#4a6070]">No upcoming operations.</p> : (
              <div className="grid md:grid-cols-2 gap-4">
                {operations.map((op) => {
                  ...
                  return (
                    <Card key={op.id} className="bg-[#0c1117] border-[rgba(0,255,136,0.1)] hover:border-[#00ff88]/30 transition-colors corner-bracket" data-testid={`hub-operation-${op.id}`}>
                      <CardHeader className="pb-2">
                        <div className="flex items-center justify-between">
                        ...
                        <CardTitle className="text-lg" style={{ fontFamily: "'Orbitron', sans-serif" }}>{op.title}</CardTitle>
                      ...
                      <CardContent>
                        ...
                        <Link to={`/hub/operations/${op.id}`}>
                          <Button size="sm" className="tactical-button bg-[#00ff88] text-[#050a0e] hover:bg-[#00cc6a] w-full" data-testid={`hub-rsvp-${op.id}`}>{isDiscordSynced ? 'VIEW DETAILS' : 'VIEW & RSVP'} <ChevronRight className="w-4 h-4 ml-1" /></Button>
                        </Link>
                      </CardContent>
                    </Card>
                  );
          ...
          {livePlans.length > 0 && (
            <section>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <h3 className="text-2xl font-bold text-[#e8c547]" style={{ fontFamily: "'Orbitron', sans-serif" }}>LIVE PLANNING</h3>
                ...
                {livePlans.map((plan) => (
                  <Card key={plan.id} className="bg-[#0c1117] border-[#ff3333]/30 hover:border-[#ff3333]/50 transition-colors relative overflow-hidden">
                    ...
                    <CardHeader className="pb-2">
                      ...
                      <CardTitle className="text-lg" style={{ fontFamily: "'Orbitron', sans-serif" }}>{plan.title}</CardTitle>
          ...
          {operationsPlans.length > 0 && (
            <section>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold text-[#e8c547]" style={{ fontFamily: "'Orbitron', sans-serif" }}>OPERATIONS PLANS</h3>
                <Link to="/hub/operations-planner"><Button size="sm" variant="outline" className="border-[rgba(0,255,136,0.15)]">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {operationsPlans.map((plan) => (
                  <Card key={plan.id} className="bg-[#0c1117] border-[rgba(0,255,136,0.1)] hover:border-[#e8c547]/30 transition-colors">
                    <CardHeader className="pb-2">
                      <div className="flex items-center justify-between">
          ...
          <section id="training">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-2xl font-bold text-[#e8c547]" style={{ fontFamily: "'Orbitron', sans-serif" }}>TRAINING PROGRAMS</h3>
            </div>
            {training.length === 0 ? <p className="text-[#4a6070]">No training scheduled.</p> : (
              <div className="grid md:grid-cols-3 gap-4">
                {training.map((t) => (
                  <Card key={t.id} className="bg-[#0c1117] border-[rgba(0,255,136,0.1)]" data-testid={`hub-training-${t.id}`}>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-lg" style={{ fontFamily: "'Orbitron', sans-serif" }}>{t.title}</CardTitle>
                    </CardHeader>
                    <CardContent>
          ...
          <section>
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-2xl font-bold text-[#e8c547]" style={{ fontFamily: "'Orbitron', sans-serif" }}>RECENT DISCUSSIONS</h3>
              <Link to="/hub/discussions"><Button size="sm" variant="outline" className="border-[rgba(0,255,136,0.15)]" data-testid="hub-view-all-discussions">View All <ChevronRight className="w-4 h-4 ml-1" /></Button></Link>
            </div>
            {discussions.length === 0 ? <p className="text-[#4a6070]">No discussions yet.</p> : (
              <div className="space-y-2">
                {discussions.map((d) => (
                  <Link to={`/hub/discussions/${d.id}`} key={d.id} className="block">
                    <Card className={`bg-[#0c1117] border-[rgba(0,255,136,0.1)] hover:border-[#00ff88]/30 active:bg-[#111a24]/50 transition-colors ${d.pinned ? 'border-l-2 border-l-[#e8c547]' : ''}`} data-testid={`hub-discussion-${d.id}`}>
                      <CardContent className="py-3">
                        <div className="flex items-start sm:items-center justify-between gap-2">
                          <div className="flex flex-wrap items-center gap-2 sm:gap-3 min-w-0">
                            {d.pinned && <Pin className="w-3.5 h-3.5 text-[#e8c547] shrink-0" />}
                            <Badge variant="outline" className="text-xs border-[rgba(0,255,136,0.15)] shrink-0">{d.category}</Badge>
