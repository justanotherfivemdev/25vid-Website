...
const RecruitDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#050a0e] text-white flex items-center justify-center">
    ...
    <div className="min-h-screen bg-[#050a0e] text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#050a0e]/92 backdrop-blur-xl border-b border-tropic-gold/15">
        <div className="container mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold tracking-widest text-tropic-gold" style={{ fontFamily: "'Share Tech', sans-serif" }}>
              RECRUIT STATUS
            </h1>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Button size="sm" variant="outline" onClick={handleLogout} className="border-[rgba(201,162,39,0.15)]">
      ...
      <div className="pt-24 pb-16 px-4 md:px-6">
        <div className="container mx-auto max-w-2xl space-y-8">
          <Card className="bg-[#0c1117]/80 border-amber-700/30" data-testid="recruit-profile-cta">
            <CardContent className="pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-semibold text-tropic-gold tracking-wider">KEEP YOUR PROFILE CURRENT</h3>
                <p className="text-sm text-[#8a9aa8] mt-1">Add your bio, timezone, and role preferences so staff can process you faster.</p>
              </div>
          ...
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold tracking-wider text-tropic-gold" style={{ fontFamily: "'Share Tech', sans-serif" }}>
              WELCOME, RECRUIT
            </h2>
          ...
          {application ? (
            <Card className="bg-[#0c1117]/80 border-tropic-red/30">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="mt-4 text-[#8a9aa8]">
                  {statusInfo?.message}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="bg-[#050a0e]/30 rounded-lg p-4 space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-[#4a6070]">Submitted:</span>
                      <div className="text-[#8a9aa8]">{new Date(application.submitted_at).toLocaleDateString()}</div>
                    </div>
                    {application.reviewed_at && (
                      <div>
                        <span className="text-[#4a6070]">Reviewed:</span>
                        <div className="text-[#8a9aa8]">{new Date(application.reviewed_at).toLocaleDateString()}</div>
                      </div>
                    )}
                  </div>
                  ...
                  {application.billet_id && (
                    <div>
                      <span className="text-[#4a6070] text-sm">Applied for:</span>
                ...
                {application.status === 'rejected' && (
                  <Alert className="bg-tropic-red/10 border-tropic-red/30">
                    ...
                    <AlertDescription className="text-[#8a9aa8]">
            ...
            <Card className="bg-[#0c1117]/80 border-tropic-red/30">
              <CardHeader>
                <CardTitle className="text-tropic-gold" style={{ fontFamily: "'Share Tech', sans-serif" }}>
                  ...
                  {billets.length > 0 && (
                    <div>
                      ...
                      <select 
                        ...
                        className="w-full bg-[#050a0e] border border-[rgba(201,162,39,0.15)] rounded-md px-3 py-2 text-white"
          ...
          <Card className="bg-[#0c1117]/50 border-[rgba(201,162,39,0.12)]">
            <CardContent className="py-6">
              <h3 className="text-sm font-bold text-tropic-gold mb-3" style={{ fontFamily: "'Share Tech', sans-serif" }}>
                WHAT HAPPENS NEXT?
              </h3>
              <ul className="text-sm text-[#8a9aa8] space-y-2">
          ...
          <div className="text-center">
            <Link to="/">
              <Button variant="outline" className="border-[rgba(201,162,39,0.15)] text-[#8a9aa8]">
                Return to Main Site
              </Button>
            </Link>
          </div>
