...
const PartnerApply = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050a0e] flex items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full space-y-6">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-bold text-tropic-gold tracking-wider" style={{ fontFamily: "'Share Tech', sans-serif" }}>
            PARTNER UNIT APPLICATION
          </h1>
          <p className="text-xs text-tropic-olive tracking-widest">S-5 LIAISON — ALLIED UNIT ENROLLMENT</p>
          <p className="text-sm text-[#8a9aa8] max-w-sm mx-auto">
        ...
        <Card className="bg-[#0c1117]/90 border-tropic-olive/30">
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="text-xs text-[#8a9aa8] block mb-1">Unit Name *</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs text-[#8a9aa8] block mb-1">Contact Name</label>
                  <Input name="contact_name" value={form.contact_name} onChange={handleChange}
                    placeholder="Unit POC name"
                    className="bg-[#050a0e]/50 border-[rgba(201,162,39,0.15)] focus:border-tropic-olive" />
                </div>
                <div>
                  <label className="text-xs text-[#8a9aa8] block mb-1">Contact Email *</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs text-[#8a9aa8] block mb-1">Unit Timezone</label>
                  <Input name="unit_timezone" value={form.unit_timezone} onChange={handleChange}
                    placeholder="e.g. US/Eastern, UTC+2"
                    className="bg-[#050a0e]/50 border-[rgba(201,162,39,0.15)] focus:border-tropic-olive" />
                </div>
                <div>
                  <label className="text-xs text-[#8a9aa8] block mb-1">Approximate Member Count</label>
              ...
              <div>
                <label className="text-xs text-[#8a9aa8] block mb-1">Description of Unit</label>
                <Textarea name="description" value={form.description} onChange={handleChange}
                  placeholder="Brief overview of your unit, background, and operations"
                  rows={3} className="bg-[#050a0e]/50 border-[rgba(201,162,39,0.15)] focus:border-tropic-olive" />
              </div>

              <div>
                <label className="text-xs text-[#8a9aa8] block mb-1">Primary Unit Tasking</label>
              ...
              <div>
                <label className="text-xs text-[#8a9aa8] block mb-1">Additional Information</label>
                <Textarea name="additional_info" value={form.additional_info} onChange={handleChange}
                  ...
                  rows={2} className="bg-[#050a0e]/50 border-[rgba(201,162,39,0.15)] focus:border-tropic-olive" />
              </div>
